...
public class Vocabulary {
    ...
    public static final String s_p_password = "http://onto.fel.cvut.cz/ontologies/stamp/password";
    ...
    public final static String s_p_has_event_type = "http://onto.fel.cvut.cz/ontologies/stamp/has_event_type";
    public final static String s_p_has_key = "http://onto.fel.cvut.cz/ontologies/documentation/has_key";
    public final static String s_c_has_participant= "http://onto.fel.cvut.cz/ontologies/ufo/has_participant";
    public final static String s_c_has_trop= "http://onto.fel.cvut.cz/ontologies/ufo/has_trope";
